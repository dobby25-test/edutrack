  ...
  return (
    <>
      <style>{`
        ...
        .um-card input,.um-card select{border:1px solid #c7cfdb;border-radius:8px;padding:9px 10px;font-size:14px}
        .um-primary,.um-secondary{border:0;border-radius:8px;padding:10px 12px;cursor:pointer;font-weight:600}
        ...
        .um-preview table{width:100%;border-collapse:collapse}
        .um-preview th,.um-preview td{border-bottom:1px solid #edf0f4;padding:8px 10px;text-align:left;font-size:12px}
        ...
        @media (max-width:720px){.um-row{grid-template-columns:1fr}}
      `}</style>
      ...
      <div className="um-wrap">
        ...
        {mode === 'single' ? <AddSingleUser onSuccess={onSuccess} /> : <BulkImport onSuccess={onSuccess} />}
      </div>
    </>
  );
}
